...
<div class="container">
    ...
    <form method="POST" action="{{route('empresas.store')}}">
        ...
        <div class="grid">
          ...
          <label for="titular">
            Titular de Empresa
            <input type="text" id="titular" name="titular" placeholder="Titular" value="{{old('titular')}}">
          </label>
        ...
        <div class="grid">
          ...
          <label for="condicion_iva_id">
            ...
            <select id="condicion_iva_id" name="condicion_iva_id" required>
              <option value="1" {{ old('condicion_iva_id') == 1 ? 'selected' : '' }}>Responsable Inscripto</option>
              <option value="6" {{ old('condicion_iva_id') == 6 ? 'selected' : '' }}>Monotributo</option>
              <option value="5" {{ old('condicion_iva_id') == 5 ? 'selected' : '' }}>Consumidor Final</option>
              <option value="4" {{ old('condicion_iva_id') == 4 ? 'selected' : '' }}>IVA Sujeto Exento</option>
            </select>
          </label>

          <label for="aliasTranferencia">
            Alias de transferencia
            <input type="text" id="aliasTranferencia" name="aliasTranferencia" placeholder="Alias" value="{{old('aliasTranferencia')}}">
          </label>

          <label for="claveFiscal">
            Clave Fiscal
            <input type="text" id="claveFiscal" name="clave_fiscal" placeholder="Clave Fiscal" value="{{old('clave_fiscal')}}">
          </label>
